...
func request_OcpSolutionApi_DescribeSolutionV1_0(ctx context.Context, marshaler runtime.Marshaler, client OcpSolutionApiClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DescribeSolutionV1Request
	var metadata runtime.ServerMetadata
	...
	msg, err := client.DescribeSolutionV1(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_OcpSolutionApi_DescribeSolutionV1_0(ctx context.Context, marshaler runtime.Marshaler, server OcpSolutionApiServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DescribeSolutionV1Request
	var metadata runtime.ServerMetadata
	...
	msg, err := server.DescribeSolutionV1(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterOcpSolutionApiHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OcpSolutionApiServer) error {
	...
	mux.Handle("GET", pattern_OcpSolutionApi_DescribeSolutionV1_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_OcpSolutionApi_DescribeSolutionV1_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_OcpSolutionApi_DescribeSolutionV1_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterOcpSolutionApiHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OcpSolutionApiClient) error {
	...
	mux.Handle("GET", pattern_OcpSolutionApi_DescribeSolutionV1_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_OcpSolutionApi_DescribeSolutionV1_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_OcpSolutionApi_DescribeSolutionV1_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "solutions", "solution_id"}, "", runtime.AssumeColonVerbOpt(true)))
...
var (
	...
	forward_OcpSolutionApi_DescribeSolutionV1_0 = runtime.ForwardResponseMessage
