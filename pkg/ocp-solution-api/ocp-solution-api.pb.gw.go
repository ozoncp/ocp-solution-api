...
var (
	filter_OcpSolutionApi_MultiCreateSolutionV1_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_OcpSolutionApi_MultiCreateSolutionV1_0(ctx context.Context, marshaler runtime.Marshaler, client OcpSolutionApiClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq MultiCreateSolutionV1Request
	var metadata runtime.ServerMetadata

	if err := req.ParseForm(); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_OcpSolutionApi_MultiCreateSolutionV1_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.MultiCreateSolutionV1(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_OcpSolutionApi_MultiCreateSolutionV1_0(ctx context.Context, marshaler runtime.Marshaler, server OcpSolutionApiServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq MultiCreateSolutionV1Request
	var metadata runtime.ServerMetadata
	...
	msg, err := server.MultiCreateSolutionV1(ctx, &protoReq)
	return msg, metadata, err
...
var (
	filter_OcpSolutionApi_UpdateSolutionV1_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_OcpSolutionApi_UpdateSolutionV1_0(ctx context.Context, marshaler runtime.Marshaler, client OcpSolutionApiClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateSolutionV1Request
	var metadata runtime.ServerMetadata

	if err := req.ParseForm(); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_OcpSolutionApi_UpdateSolutionV1_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.UpdateSolutionV1(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_OcpSolutionApi_UpdateSolutionV1_0(ctx context.Context, marshaler runtime.Marshaler, server OcpSolutionApiServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateSolutionV1Request
	var metadata runtime.ServerMetadata
	...
	msg, err := server.UpdateSolutionV1(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterOcpSolutionApiHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OcpSolutionApiServer) error {
	...
	mux.Handle("POST", pattern_OcpSolutionApi_MultiCreateSolutionV1_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_OcpSolutionApi_MultiCreateSolutionV1_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_OcpSolutionApi_MultiCreateSolutionV1_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_OcpSolutionApi_UpdateSolutionV1_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_OcpSolutionApi_UpdateSolutionV1_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_OcpSolutionApi_UpdateSolutionV1_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterOcpSolutionApiHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OcpSolutionApiClient) error {
	...
	mux.Handle("POST", pattern_OcpSolutionApi_MultiCreateSolutionV1_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_OcpSolutionApi_MultiCreateSolutionV1_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_OcpSolutionApi_UpdateSolutionV1_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_OcpSolutionApi_UpdateSolutionV1_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_OcpSolutionApi_MultiCreateSolutionV1_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "solutions"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_OcpSolutionApi_CreateSolutionV1_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "solution"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	pattern_OcpSolutionApi_UpdateSolutionV1_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "solution"}, "", runtime.AssumeColonVerbOpt(true)))
...
var (
	forward_OcpSolutionApi_MultiCreateSolutionV1_0 = runtime.ForwardResponseMessage
	...
	forward_OcpSolutionApi_UpdateSolutionV1_0 = runtime.ForwardResponseMessage
